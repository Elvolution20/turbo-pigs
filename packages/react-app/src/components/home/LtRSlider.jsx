  ...
  return (
    <div className="">
      <Slider {...settings}>
        ...
        <div className="Ritem">
          <img src="./assets/image/4.png" className="Ritem_img" width="190px" height="190px" />      
        </div>
        <div className="Ritem">
          <img src="./assets/image/5.png" className="Ritem_img" width="190px" height="190px" />      
        </div>
        <div className="Ritem">
          <img src="./assets/image/6.png" className="Ritem_img" width="190px" height="190px" />    
        </div>
        <div className="Ritem">
          <img src="./assets/image/7.png" className="Ritem_img" width="190px" height="190px" />
        </div>
        <div className="Ritem">
          <img src="./assets/image/8.png" className="Ritem_img" width="190px" height="190px" />
        </div>
        <div className="Ritem">
          <img src="./assets/image/9.png" className="Ritem_img" width="190px" height="190px" />
        </div>
        <div className="Ritem">
