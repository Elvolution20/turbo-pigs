  ...
  return (
    <div className="mintContainer" id="mintContainer">
      <div className="mint-title">
        ...
        <p className="mintSubtitle">Minting Start on October 22nd, 2023.</p>
      ...
      <Modal
        ...
        centered
        footer={[
          <Button key="submit" disabled={!termchecked} onClick={() => setModalVisible(false)} style={{backgroundColor: termchecked ? 'black': 'grey', color: '#ff8f8d', borderRadius: '7px', border: 'none'}}>
            Accept
          </Button>
        ]}
      ...
      >
        <h3>1. Introduction to the Turbo Pigs!</h3>
        <p>Turbo Pigs is a collection of 2,222 characters, with the expectation that they will bring a smile to the face of everyone who sees them! Thank you for visiting our terms and if you have any questions feel free to reach out to us in the Discord or on Twitter. We will be happy to chat.</p>

        <h3>2. What We Own</h3>
        <p>The name and Intellectual Property involved in the Turbo Pigs NFT Project (“Turbo Pigs”) is owned by the team here at Turbo Pigs.
          All rights that are not specifically granted to the users and owners of Turbo Pigs below are reserved by the team or future DAO.
          This includes but is not limited to the intellectual property rights surrounding the images, names, logos, 3D layer files, trademarks, the website, the ability to mint 3D or pixel or other versions of Turbo Pigs, the smart contract code, or anything else not specifically granted by any following licenses.</p>

        <h3>3. What You Own and What You Can Do With It</h3>
        <p>By connecting your Ethereum wallet and minting an NFT with our smart contract, you have purchased a Turbo Piggie!
          With this Turbo Piggie you can show it off, use it as your PFP, sell it, and even merchandise it up to $50,000 through the sale of physical merch or using your full Turbo Piggie in a piece of art you may create. Should you approach that number or expect to go beyond it please reach out to the team and we can discuss a licensing deal for anything beyond that amount.</p>

        <h3>4. Specifics on Commercial and Derivative Rights</h3>
        <p>We appreciate that you want to utilize Turbo Pigs in various ways, and even commercial ways, we are open to you doing just that!
          When it comes to limiting commercial rights, however, we want you as an NFT holder to realize that you may use the Turbo Piggie image in its fullness only!
          The individual layered files and traits are proprietary and are our own creation / use.
          We don’t want to see any other projects utilizing our individually crafted layers, so we are not open to you minting new NFTs that are derivatives of our project, change the original Turbo Piggie, or minting another full project using our Turbo Piggie in any way. (Derivatives are a little boring nowadays anyway right?)
          ...
          To limit the use even on merchandise, the user shall not use any Turbo Pigs Licensed Materials in connection with any material, which is unlawful, fraudulent, libelous, defamatory, obscene, pornographic, profane, threatening, abusive, hateful, offensive or otherwise objectionable or unreasonable or infringing upon any laws or regulations or intellectual property rights or proprietary rights or confidentiality obligations and you shall indemnify and defend the Turbo Pigs team against any claims, damages, proceedings, loss or costs arising from such use.
          User shall not use the Turbo Pigs Licensed Materials in any way that could be construed as being adverse or derogatory to the image of Turbo Pigs or any of its subjects featured in the NFTs.</p>

        <h3>5. No Guarantees or Future Promises</h3>
        <p>Turbo Pigs is working hard to put out more content and create things in the future that you can all be proud of and have outlined many of our intentions as such. However, the landscape around NFTs, DAOs and various other things we are hoping to do is shifting and legally gray in many ways.
          When you purchase your Turbo Piggie, you agree that your purchase from our initial launch of NFTs is all you are guaranteed to receive in exchange for your funds.
          Whether through primary or secondary channels, the art is what you receive. Any future benefits are ancillary to this purchase and not to be taken into consideration with your initial purchase. You agree that you are not relying on any future commitments by Turbo Pigs beyond the receiving of the art in using this site and participating in our NFT launch.</p>

        <h3>6. Turbo Pigs Are Not Intended as Investments</h3>
        <p>Turbo Pigs are meant to be a cool Non-Fungible Token for you to collect. They are not meant as investment vehicles. We make absolutely no promise or guarantee that these NFTs will be worth anything more than what the market deems the art to be worth. This could very well be zero. (Let’s hope not!)
          ...
          You understand that Turbo Pigs have no inherent monetary value, and they should be treated as nothing more than a collectible with potential future value or lack thereof.</p>

        <h3>7. Taxes</h3>
        <p>You are entirely responsible for any tax liability which may arise from minting or reselling your Turbo Pigs.</p>

        <h3>8. Children</h3>
        <p>The Turbo Pigs project is not targeted towards children. You agree that you are over the age of 18, or above the legal age of your jurisdiction, whichever is greater.</p>
      ...
      <div className="mint-image">
        <img src="./assets/image/Turbo-Lineup.png" alt="Turbo-Lineup"/>
      </div>
      <ToastContainer
        position="top-right"
        autoClose={5000}
